...
let websites = JSON.parse(fs.readFileSync('data/websites.json', 'utf-8'));
...
let blocker = () => {
  ...
  if (hours >= 14 && hours < 18) {
     ...
     * We will keep on appending the lines which do not contain our websites to
     * this string At the end, we will replace the file contents by this string
     */
    let completeContent = '';
